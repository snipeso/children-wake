...
AllOutcomeVariables =  {'Globality', 'Amplitude', 'Duration', 'Density',  'Exponent', 'Offset','Power', 'PeriodicPower', 'AperiodicPower', 'SWASlope', 'SWAAmp', 'Error', 'RSquared'};
...
for Cat1RowIdx = 1:size(Metadata1, 1)
    ...
    PairedMetadata(end, AllOutcomeVariables) = ...
        Metadata2(MorRowIdx, AllOutcomeVariables) - Metadata1(Cat1RowIdx, AllOutcomeVariables);
